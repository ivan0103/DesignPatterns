...
public class ErrorMessageFactory {
	...
	private ErrorMessageFactory() {
		...
		errorMessages.put(ErrorType.PageNotFoundError, new SystemErrorMessage("Page not found. An error $errorCode occurred. Please refer to:\n", "http://google.com/q="));
		errorMessages.put(ErrorType.ServerError, new SystemErrorMessage("A system error of type $errorCode occurred. Please refer to:\n", "http://google.com/q="));
	}
